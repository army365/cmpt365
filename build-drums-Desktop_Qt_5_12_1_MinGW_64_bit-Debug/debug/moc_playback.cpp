...
QT_MOC_LITERAL(3, 20, 7), // "soundId"
QT_MOC_LITERAL(4, 28, 13), // "trackFinished"
QT_MOC_LITERAL(5, 42, 4), // "play"
QT_MOC_LITERAL(6, 47, 4) // "stop"

    },
    "playback\0playSound\0\0soundId\0trackFinished\0"
    "play\0stop"
};
...
void playback::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->playSound((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 1: _t->trackFinished(); break;
        ...
        {
            using _t = void (playback::*)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&playback::playSound)) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&playback::trackFinished)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void playback::playSound(int _t1)
{
